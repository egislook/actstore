...
var program = require('commander')
  ...
  .option('-a, --actstore', 'Screen Component with ActStore')
  .option('-m, --minimal', 'Screen Component with only index.js')
  .parse(process.argv)
...
function createComponent(name) {
  ...
  console.log(
    `${isUpperCase(name)} Component ${name}${program.actstore ? ' with useActStore()' : ''} created`
  )
}
